...
if("FALSE" STREQUAL "TRUE")
  set(moveit_core_SOURCE_PREFIX /home/ruinianxu/ws_moveit/src/moveit/moveit_core)
  set(moveit_core_DEVEL_PREFIX /home/ruinianxu/ws_moveit/devel/.private/moveit_core)
  ...
  set(moveit_core_INSTALL_PREFIX /home/ruinianxu/ws_moveit/install)
...
if(NOT "include;/usr/include;/usr/include/eigen3;/opt/ros/kinetic/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'moveit_core' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ruinianxu/ws_moveit/install/${idir}'.  Ask the maintainer 'Dave Coleman <dave@dav.ee>, Michael Görner <me@v4hn.de>, Michael Ferguson <mferguson@fetchrobotics.com>' to fix it.")
    endif()
