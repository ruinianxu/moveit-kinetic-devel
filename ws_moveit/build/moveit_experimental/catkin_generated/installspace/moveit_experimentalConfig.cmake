...
if("FALSE" STREQUAL "TRUE")
  set(moveit_experimental_SOURCE_PREFIX /home/ruinianxu/ws_moveit/src/moveit/moveit_experimental)
  set(moveit_experimental_DEVEL_PREFIX /home/ruinianxu/ws_moveit/devel/.private/moveit_experimental)
  ...
  set(moveit_experimental_INSTALL_PREFIX /home/ruinianxu/ws_moveit/install)
...
if(NOT "include;/opt/ros/kinetic/include;/usr/include/eigen3;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'moveit_experimental' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ruinianxu/ws_moveit/install/${idir}'.  Ask the maintainer 'Michael Ferguson <mferguson@fetchrobotics.com>, Chittaranjan Srinivas Swaminathan <chitt@live.in>' to fix it.")
    endif()
