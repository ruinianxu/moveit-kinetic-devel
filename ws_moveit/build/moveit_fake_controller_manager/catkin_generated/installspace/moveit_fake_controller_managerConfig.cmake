...
if("FALSE" STREQUAL "TRUE")
  set(moveit_fake_controller_manager_SOURCE_PREFIX /home/ruinianxu/ws_moveit/src/moveit/moveit_plugins/moveit_fake_controller_manager)
  set(moveit_fake_controller_manager_DEVEL_PREFIX /home/ruinianxu/ws_moveit/devel/.private/moveit_fake_controller_manager)
  ...
  set(moveit_fake_controller_manager_INSTALL_PREFIX /home/ruinianxu/ws_moveit/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'moveit_fake_controller_manager' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ruinianxu/ws_moveit/install/${idir}'.  Ask the maintainer 'Michael Görner <me@v4hn.de>' to fix it.")
    endif()
