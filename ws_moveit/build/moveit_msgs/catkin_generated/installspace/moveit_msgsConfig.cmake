...
if("FALSE" STREQUAL "TRUE")
  set(moveit_msgs_SOURCE_PREFIX /home/ruinianxu/ws_moveit/src/moveit_msgs)
  set(moveit_msgs_DEVEL_PREFIX /home/ruinianxu/ws_moveit/devel/.private/moveit_msgs)
  ...
  set(moveit_msgs_INSTALL_PREFIX /home/ruinianxu/ws_moveit/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'moveit_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ruinianxu/ws_moveit/install/${idir}'.  Ask the maintainer 'Dave Coleman <dave@dav.ee>, Michael Ferguson <mferguson@fetchrobotics.com>, Michael Goerner <me@v4hn.de>, Robert Haschke <rhaschke@techfak.uni-bielefeld.de>, Isaac I. Y. Saito <130s@2000.jukuin.keio.ac.jp>' to fix it.")
    endif()
