...
if("FALSE" STREQUAL "TRUE")
  set(moveit_resources_SOURCE_PREFIX /home/ruinianxu/ws_moveit/src/moveit_resources)
  set(moveit_resources_DEVEL_PREFIX /home/ruinianxu/ws_moveit/devel/.private/moveit_resources)
  ...
  set(moveit_resources_INSTALL_PREFIX /home/ruinianxu/ws_moveit/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'moveit_resources' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ruinianxu/ws_moveit/install/${idir}'.  Ask the maintainer 'Dave Coleman <dave@dav.ee>' to fix it.")
    endif()
