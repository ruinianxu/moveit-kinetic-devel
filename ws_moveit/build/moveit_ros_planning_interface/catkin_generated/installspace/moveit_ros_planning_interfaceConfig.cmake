...
if("FALSE" STREQUAL "TRUE")
  set(moveit_ros_planning_interface_SOURCE_PREFIX /home/ruinianxu/ws_moveit/src/moveit/moveit_ros/planning_interface)
  set(moveit_ros_planning_interface_DEVEL_PREFIX /home/ruinianxu/ws_moveit/devel/.private/moveit_ros_planning_interface)
  ...
  set(moveit_ros_planning_interface_INSTALL_PREFIX /home/ruinianxu/ws_moveit/install)
...
if(NOT "include;/usr/include/eigen3 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'moveit_ros_planning_interface' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ruinianxu/ws_moveit/install/${idir}'.  Ask the maintainer 'Michael Ferguson <mferguson@fetchrobotics.com>, Michael Görner <me@v4hn.de>' to fix it.")
    endif()
