...
if("FALSE" STREQUAL "TRUE")
  set(pr2_description_SOURCE_PREFIX /home/ruinianxu/ws_moveit/src/pr2_common/pr2_description)
  set(pr2_description_DEVEL_PREFIX /home/ruinianxu/ws_moveit/devel/.private/pr2_description)
  ...
  set(pr2_description_INSTALL_PREFIX /home/ruinianxu/ws_moveit/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pr2_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ruinianxu/ws_moveit/install/${idir}'.  Ask the maintainer 'Devon Ash <dash@clearpathrobotics.com>' to fix it.")
    endif()
